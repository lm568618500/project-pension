...
public class AuthTaobaoRequest extends BaseAuthRequest {
	...
	protected AuthUser getUserInfo(AuthToken authToken) {
		...
		HttpResponse response = HttpRequest.post(UrlBuilder.getTaobaoAccessTokenUrl(this.config.getClientId(),
				this.config.getClientSecret(), accessCode, this.config.getRedirectUri())).execute();
