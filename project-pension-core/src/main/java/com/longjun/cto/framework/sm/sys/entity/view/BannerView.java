...
public class BannerView extends BaseView {
	...
	public BannerView(BannerModel model) {
		this.id = model.getId();
		this.type = model.getType();
		this.time = model.getTime();
		this.location = model.getLocation();
		this.name = model.getName();
		this.plateId = model.getPlateId();
		...
		this.isLinkEnabled = model.getIsLinkEnabled();
		this.target = model.getTarget();
		this.sort = model.getSort();
		this.status = model.getStatus();
		this.jumpId = model.getJumpId();
		this.jumpType = model.getJumpType();
		this.jumpUrl = model.getJumpUrl();
