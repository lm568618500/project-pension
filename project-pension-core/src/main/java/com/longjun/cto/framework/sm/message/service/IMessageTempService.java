 ...
 */
public interface IMessageTempService extends BaseService<MessageTempModel> {
	 ...
	 * @throws BusinessException
	 */
	PageUtils<MessageTempView> getByPage(MessageTempDto dto) throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	List<MessageTempView> listByLimitStatus(int status , int limit)throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	List<MessageTempView> listAll()throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	boolean modify(MessageTempModifyDto dto)throws BusinessException;
