 ...
 */
public interface IOssResStoreService extends BaseService<OssResStoreModel> {
	 ...
	 * @throws BusinessException
	 */
	PageUtils<OssResStoreView> getByPage(OssResStoreDto dto) throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	List<OssResStoreView> listByLimitStatus(int status , int limit)throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	List<OssResStoreView> listAll()throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	boolean modify(OssResStoreModifyDto dto)throws BusinessException;
