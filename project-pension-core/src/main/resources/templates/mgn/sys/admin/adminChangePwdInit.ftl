...
<form class="layui-form" style="width:80%;">
		<input type="hidden" name="adminId" disabled value="${adminView.id}" id="adminId" autocomplete="off" class="layui-input">
    	<div class="layui-form-item">
	        <label class="layui-form-label">账号</label>
	        <div class="layui-input-block">
	        	<input type="text" name="account" disabled value="${adminView.account}" id="account" autocomplete="off" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
