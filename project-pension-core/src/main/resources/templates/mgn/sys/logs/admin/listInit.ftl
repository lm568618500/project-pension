...
<fieldset class="layui-elem-field">
    <legend>管理员操作日志</legend>
    <div class="layui-field-box">
    <form class="layui-form">
        <div class="layui-inline" style="margin-left: 15px">
            <label>管理员:</label>
            <div class="layui-input-inline">
                <input type="text" name="c_operaterName" lay-verify="title" autocomplete="off" placeholder="请输入管理员" class="layui-input">
            </div>
        </div>
...
<script>
    layui.use(['layer','form','table','laydate'], function() {
        ...
        t = {
            elem: '#test',
            url:'${serverPath}/mgn/sys/logs/admin/getByPage',
            method:'post',
