...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="cityId" lay-verify="title" autocomplete="off" placeholder="请输入城市ID" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/sys/commonArea/saveModel",data.field,function(res){
