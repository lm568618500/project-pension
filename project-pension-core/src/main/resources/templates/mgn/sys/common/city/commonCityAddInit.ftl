...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">试用ID</label>
	        <div class="layui-input-block">
	        	<input type="text" name="useId" lay-verify="title" autocomplete="off" placeholder="请输入试用ID" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">省份UseId</label>
	        <div class="layui-input-block">
	        	<input type="text" name="provinceId" lay-verify="title" autocomplete="off" placeholder="请输入省份UseId" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/sys/commonCity/saveModel",data.field,function(res){
