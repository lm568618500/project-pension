    ...
    <form class="layui-form">
        <div class="layui-inline" style="margin-left: 15px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="c_key" lay-verify="title" autocomplete="off" placeholder="请输入键" class="layui-input">
            </div>
        </div>
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${serverPath}/mgn/sys/common/option/getByPage',
            method:'post',
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === "editInit"){
                var addIndex = layer.open({
                    title : "编辑配置",
                    type : 2,
                    content : "${serverPath}/mgn/sys/common/option/commonoptionEditInit?id="+data.id,
