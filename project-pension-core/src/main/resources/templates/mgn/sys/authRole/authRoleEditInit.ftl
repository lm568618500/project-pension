...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="rolename" value="${view.rolename}" lay-verify="title" autocomplete="off" placeholder="请输入名称" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">描述</label>
	        <div class="layui-input-block">
	        	<input type="text" name="roleDesc" value="${view.roleDesc}" lay-verify="title" autocomplete="off" placeholder="请输入描述" class="layui-input">
	        </div>
    	</div>
    ...
    layui.use(['form','jquery','layer','laydate','layedit','authtree'],function(){
       var form = layui.form,
        ...
        var menusSelected; 		
	 	 // 初始化
		$.ajax({
			url: '${serverPath}/mgn/sys/authResources/getOwnerAllMenus?roleUseId=${view.useId}',
			dataType: 'json',
        ...
        form.on("submit(modify)",function(data){
            ...
            $.post("${serverPath}/mgn/sys/authRole/modify",data.field,function(res){
