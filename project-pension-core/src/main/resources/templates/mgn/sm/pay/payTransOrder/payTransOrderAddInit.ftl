...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">转账状态:0-订单生成,1-转账中,2-转账成功,3-转账失败,4-业务处理完成</label>
	        <div class="layui-input-block">
	        	<input type="text" name="status" lay-verify="title" autocomplete="off" placeholder="请输入转账状态:0-订单生成,1-转账中,2-转账成功,3-转账失败,4-业务处理完成" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label"></label>
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">转账订单号</label>
	        <div class="layui-input-block">
	        	<input type="text" name="transOrderId" lay-verify="title" autocomplete="off" placeholder="请输入转账订单号" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">商户转账单号</label>
	        <div class="layui-input-block">
	        	<input type="text" name="mchTransNo" lay-verify="title" autocomplete="off" placeholder="请输入商户转账单号" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="channelItemsId" lay-verify="title" autocomplete="off" placeholder="请输入支付方式" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">转账金额,单位分</label>
	        <div class="layui-input-block">
	        	<input type="text" name="amount" lay-verify="title" autocomplete="off" placeholder="请输入转账金额,单位分" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">转账结果:0-不确认结果,1-等待手动处理,2-确认成功,3-确认失败</label>
	        <div class="layui-input-block">
	        	<input type="text" name="result" lay-verify="title" autocomplete="off" placeholder="请输入转账结果:0-不确认结果,1-等待手动处理,2-确认成功,3-确认失败" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">订单转账成功时间</label>
	        <div class="layui-input-block">
	        	<input type="text" name="transSuccTime" id="transSuccTime" autocomplete="off" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label"></label>
	        <div class="layui-input-block">
	        	<input type="text" name="buzNotifyUrl" lay-verify="title" autocomplete="off" placeholder="请输入" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label"></label>
	        <div class="layui-input-block">
	        	<input type="text" name="buzNotifyResp" lay-verify="title" autocomplete="off" placeholder="请输入" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label"></label>
	        <div class="layui-input-block">
	        	<input type="text" name="buzStatus" lay-verify="title" autocomplete="off" placeholder="请输入" class="layui-input">
	        </div>
    	</div>
		<div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/sm/pay/payTransOrder/saveModel",data.field,function(res){
