...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="channelId" lay-verify="title" autocomplete="off" placeholder="请输入渠道名称" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">渠道子方式名称</label>
	        <div class="layui-input-block">
	        	<input type="text" name="channelItemsName" lay-verify="title" autocomplete="off" placeholder="请输入渠道子方式名称" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/pay/payChannelItemDict/saveModel",data.field,function(res){
