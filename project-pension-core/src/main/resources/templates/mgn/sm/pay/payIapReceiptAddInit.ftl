...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">处理状态:0-未处理,1-处理成功,-1-处理失败</label>
	        <div class="layui-input-block">
	        	<input type="text" name="status" lay-verify="title" autocomplete="off" placeholder="请输入处理状态:0-未处理,1-处理成功,-1-处理失败" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label"></label>
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">IAP业务号</label>
	        <div class="layui-input-block">
	        	<input type="text" name="transactionId" lay-verify="title" autocomplete="off" placeholder="请输入IAP业务号" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">渠道ID</label>
	        <div class="layui-input-block">
	        	<input type="text" name="receiptData" lay-verify="title" autocomplete="off" placeholder="请输入渠道ID" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">处理次数</label>
	        <div class="layui-input-block">
	        	<input type="text" name="handleCount" lay-verify="title" autocomplete="off" placeholder="请输入处理次数" class="layui-input">
	        </div>
    	</div>
		<div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/sm/pay/payIapReceipt/saveModel",data.field,function(res){
