    ...
    <form class="layui-form">
        <div class="layui-inline" style="margin-left: 15px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="c_title" lay-verify="title" autocomplete="off" placeholder="请输入协议名称" class="layui-input">
            </div>
        </div>
...
<script>
    layui.use(['layer','form','table'], function() {
		...
		var cols = [
					{field:'title', title: '协议名称'},
					{field:'contents', title: '协议内容'},
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === "editInit"){
                var addIndex = layer.open({
                    title : "编辑数据",
                    type : 2,
                    content : "${serverPath}/mgn/sm/cms/cmsContent/editPactPage?id=" + data.id,
