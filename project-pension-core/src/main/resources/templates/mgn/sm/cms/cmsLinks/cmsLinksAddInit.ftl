...
<form class="layui-form" style="width:80%;">
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="linkName" lay-verify="title" autocomplete="off" placeholder="请输入合伙伙伴名称" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="linkHref" lay-verify="title" autocomplete="off" placeholder="请输入超链接" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['upload','form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/sm/cms/cmsLinks/saveModel",data.field,function(res){
