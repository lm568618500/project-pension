...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="feedNo" lay-verify="title" autocomplete="off" placeholder="请输入反馈编号" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">管理员ID</label>
	        <div class="layui-input-block">
	        	<input type="text" name="adminId" lay-verify="title" autocomplete="off" placeholder="请输入管理员ID" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">回答时间</label>
	        <div class="layui-input-block">
	        	<input type="text" name="ackTime" id="ackTime" autocomplete="off" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">回答内容</label>
	        <div class="layui-input-block">
	        	<input type="text" name="ackContent" lay-verify="title" autocomplete="off" placeholder="请输入回答内容" class="layui-input">
	        </div>
    	</div>
		<div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/sm/cms//cmsFeedAck/saveModel",data.field,function(res){
