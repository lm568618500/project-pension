...
<form class="layui-form" style="width:80%;">
	<input type="hidden" name="id" value="${view.id}" />
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	            <input type="text" name="tempUid"
	           		value="${view.tempName !''}" disabled lay-verify="required" autocomplete="off"  class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="checkbox" name="emailimmediately" lay-skin="switch"  value="1" <#if view.emailimmediately == 1>checked</#if> lay-text="ON|OFF">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(modify)",function(data){
            ...
            $.post("${serverPath}/mgn/message/messageTempEmail/modify",data.field,function(res){
