...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	            <input type="text" name="otherTemplateId"
	           		value="${view.otherTemplateId !''}" disabled lay-verify="title" autocomplete="off"  class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
        		<input type="checkbox" name="immediately" lay-skin="switch" lay-text="是|否" disabled <#if view.immediately == 1>checked</#if>  >
	        </div>
    	</div>
    	<div class="layui-form-item">
