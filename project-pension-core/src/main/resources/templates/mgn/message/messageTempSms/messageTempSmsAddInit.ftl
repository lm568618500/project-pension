...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">第三方模板ID</label>
	        <div class="layui-input-block">
	        	<input type="text" name="otherTemplateId" lay-verify="title" autocomplete="off" placeholder="请输入第三方模板ID" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">短信内容</label>
	        <div class="layui-input-block">
	        	<input type="text" name="smsContent" lay-verify="title" autocomplete="off" placeholder="请输入短信内容" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">短信开关0关闭 1开启</label>
	        <div class="layui-input-block">
	        	<input type="text" name="status" lay-verify="title" autocomplete="off" placeholder="请输入短信开关0关闭 1开启" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">短信立刻0非立刻 1立刻</label>
	        <div class="layui-input-block">
	        	<input type="text" name="immediately" lay-verify="title" autocomplete="off" placeholder="请输入短信立刻0非立刻 1立刻" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/message/messageTempSms/saveModel",data.field,function(res){
