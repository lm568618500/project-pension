...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        <label class="layui-form-label">是否删除 0 正常 -1删除</label>
	        <div class="layui-input-block">
	        	<input type="text" name="isDel" lay-verify="title" autocomplete="off" placeholder="请输入是否删除 0 正常 -1删除" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">网关名称</label>
	        <div class="layui-input-block">
	        	<input type="text" name="gatwayName" lay-verify="title" autocomplete="off" placeholder="请输入网关名称" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">网关值</label>
	        <div class="layui-input-block">
	        	<input type="text" name="gatwayValue" lay-verify="title" autocomplete="off" placeholder="请输入网关值" class="layui-input">
	        </div>
    	</div>
    	<div class="layui-form-item">
    ...
    layui.use(['form','jquery','layer','laydate','layedit'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/message/messageGatway/saveModel",data.field,function(res){
