 ...
 <@extends name="//common/top_menu.ftl"/>
  ...
  <div class="box-container-fluid index-box-1">
    <div class="box-container">
      <div class="info-box wow fadeInLeft50">
        ...
        <div class="caption">吉隆之喜 万象天成</div>
        <div class="content">
          吉万集团是一家集清洁清洗设备研发、生产、销售，综合物业，市政环卫，园林绿化等诸多核心业务于一体的集团公司。
          深圳市吉万实业有限公司创立于2002年7月，随着经济全球化进程的不断加快和中国经济体制改革的纵深推进，公司顺势而为，
          于2014年7月组建为深圳市吉万实业集团，其旗下拥有深圳市吉万实业有限公司、深圳市吉万建筑装饰工程有限公司、深圳市吉万清洁用品有限公司、深圳市吉万物业管理有限公司等成员企业。
  ...
  <div class="box-container-fluid index-box-2">
    ...
    <div class="imgs">
      ...
      <div class="item">
        <img src="${GlobalMap['SYS_PRODUCT_IMG']}" alt="${oneList.name!}" class="pc"><img src="${GlobalMap['SYS_PRODUCT_IMG']}" alt="${oneList.name!}" class="phone">
        <div class="list">
          <div class="box-container">
            <ul>
              <#list oneList.twoList as twoList>
                <li><a href="${serverPath}/jw/news?oneId=${twoList.parentOneId!}&twoId=${twoList.id!}&threeId=0&fourId=0&newId=0">${twoList.name!}</a></li>
              </#list>
            </ul>
          </div>
        </div>
    ...
    <div class="index-cat-box">
      <div class="box-container wow fadeInUp50">
        ...
        <a href="javascript:;" onmouseenter="boxToggle(this)">
          <div class="icon">
            <!-- 触发前 -->
            <img src="<#if oneList.id==1>${PubStaticServer}/static/jw/images/2020071416024267.png</#if><#if oneList.id==2>${PubStaticServer}/static/jw/images/20200714160250423.png</#if><#if oneList.id==3>${PubStaticServer}/static/jw/images/20200714160324265.png</#if>" alt="${oneList.name!}" class="original">
            <!-- 触发后 -->
            <img src="<#if oneList.id==1>${PubStaticServer}/static/jw/images/20200714160132583.png</#if><#if oneList.id==2>${PubStaticServer}/static/jw/images/20200714160257384.png</#if><#if oneList.id==3>${PubStaticServer}/static/jw/images/20200714160331825.png</#if>" alt="${oneList.name!}" class="on">
          </div>
          <div class="name">${oneList.name!}</div>
        </a>
        </#list>
        ...
        <div class="swiper-container news-swiper">
          <div class="swiper-wrapper">
            <#list newsList as newsList>
              <div class="swiper-slide">
                <a href="${serverPath}/jw/news?oneId=${newsList.typeOneId!}&twoId=${newsList.typeTwoId!}&threeId=0&fourId=0&newId=${newsList.id}">
                  <div class="pic"><img src="${newsList.images}" alt="${newsList.name}"></div>
                  <div class="info">
                    <div class="name">${newsList.name!}</div>
                    <div class="desc">${newsList.describes!}</div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <a href="${serverPath}/jw/news?oneId=${newsList.typeOneId!}&twoId=${newsList.typeTwoId!}&threeId=0&fourId=0&newId=${newsList.id}">
              <div class="info">
                <div class="name">${newsList.name!}</div>
                <div class="desc">${newsList.describe!}</div>
                <div class="index-more-2">更多<i></i><i></i><i></i><i></i></div>
              </div>
