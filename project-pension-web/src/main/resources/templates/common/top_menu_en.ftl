    ...
    <div class="pc-nav-box">
        <ul>
            <#list oneWebList as oneWebList>
                <li><a href="${serverPath}/jw/newsEn?oneId=${oneWebList.id!}&twoId=0&threeId=0&fourId=0&newId=0">${oneWebList.nameEn!}</a></li>
            </#list>
        </ul>
        <div class="child-box">
            <#list oneWebList as oneWebList>
                <div class="hide-box">
                    <div class="w1200">
                        <div class="info">
                            <img src="${oneWebList.image!}" alt="${oneWebList.nameEn!}" width="580" height="210">
                            <div class="caption-box">
                            </div>
                        </div>
                        <div class="nav">
                            <#list oneWebList.twoList as  twoList>
                            <a class href="${serverPath}/jw/newsEn?oneId=${oneWebList.id!}&twoId=${twoList.id!}&threeId=0&fourId=0&newId=0">${twoList.nameEn!}</a>
                            </#list>
                        </div>
                    </div>
                </div>
...
<div class="phone-nav" id="phone-nav">
    <ul>
        ...
        <#list oneWebList as oneWebList>
            <li>
                <!-- 有二级样式 a.cat-->
                <a href="javascript:;">${oneWebList.nameEn!}</a>
                <div class="nav">
                    <#list oneWebList.twoList as  twoList>
                        <a class href="/about/index.html">${twoList.nameEn!}</a>
                    </#list>
                </div>
            </li>
        </#list>
