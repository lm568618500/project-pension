 ...
 * @author liuming
 */
@RequestMapping("/jw/aboutUs")
@Controller
public class AboutUsController extends CqcWebBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping(value = "/companyProfile", method = {RequestMethod.POST, RequestMethod.GET})
    public ModelAndView companyProfile(long oneId,long twoId,long threeId,long fourId,long newId) {
        //新闻
        ...
        ModelAndView model = getModelAndView("/jw/aboutUs/companyProfile");
