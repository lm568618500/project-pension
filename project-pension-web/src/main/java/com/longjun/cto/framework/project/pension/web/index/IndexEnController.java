...
@RequestMapping("")
@Controller
public class IndexEnController extends CqcWebBaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/indexEn", method = {RequestMethod.POST, RequestMethod.GET})
    public ModelAndView indexEn() {

        //UsersView usersView = currentUser();
        ModelAndView model = getModelAndView("/index/indexEn");
        //一级分类
