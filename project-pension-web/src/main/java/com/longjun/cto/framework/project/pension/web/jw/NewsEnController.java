...
@RequestMapping("/jw")
@Controller
public class NewsEnController extends CqcWebBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping(value = "/newsEn", method = {RequestMethod.POST, RequestMethod.GET})
    public ModelAndView newsEn(long oneId,long twoId,long threeId,long fourId,long newId) {
        //新闻
        ...
        ModelAndView model = getModelAndView("/jw/news/newsEn");
