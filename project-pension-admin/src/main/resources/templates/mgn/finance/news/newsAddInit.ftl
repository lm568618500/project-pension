...
<form class="layui-form" style="width:80%;">
    	...
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
	        	<input type="text" name="name" lay-verify="title" autocomplete="off" placeholder="请输入新闻名称" class="layui-input">
	        </div>
    	</div>
		<div class="layui-form-item">
			<label class="layui-form-label">新闻名称（英文）</label>
			<div class="layui-input-block">
				<input type="text" name="nameEn" lay-verify="title" autocomplete="off" placeholder="请输入新闻名称（英文）" class="layui-input">
			</div>
		</div>
    	<div class="layui-form-item">
	        <label class="layui-form-label">新闻描述</label>
	        <div class="layui-input-block">
	        	<input type="text" name="describes" lay-verify="title" autocomplete="off" placeholder="请输入新闻描述" class="layui-input">
	        </div>
    	</div>
		<div class="layui-form-item">
			<label class="layui-form-label">新闻描述（英文）</label>
			<div class="layui-input-block">
				<input type="text" name="describeEn" lay-verify="title" autocomplete="off" placeholder="请输入新闻描述（英文）" class="layui-input">
			</div>
		</div>
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
				...
				<textarea style="display: none;" id="pact"  name="pact" class="layui-textarea"></textarea>
			</div>
    	</div>
    	<div class="layui-form-item">
	        ...
	        <div class="layui-input-block">
				...
				<textarea style="display: none;" id="pactEn"  name="pactEn" class="layui-textarea"></textarea>
			</div>
    	</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<div class="layui-upload-list">
					<video src="" controls="controls" id="video1" width="100px" height="100px"></video>
    ...
    layui.use(['form','jquery','layer','laydate','layedit','upload'],function(){
       var form = layui.form,
        ...
        form.on("submit(saveModel)",function(data){
            ...
            $.post("${serverPath}/mgn/finance/news/saveModel",data.field,function(res){
